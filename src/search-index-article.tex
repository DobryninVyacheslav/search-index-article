...
\begin{document}
    ...
    In this regard, modern search engines use two stages of selection of relevant documents~\cite{multiStageRetrieval}.
    ...
    due to a mismatch between the query dictionary and documents~\cite{vocabularyMismatch}.
